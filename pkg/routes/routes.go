...
func SetServiceRoutes(c controller.ServiceInfoController, router *mux.Router) *mux.Router {
	router.HandleFunc("/project/{id}/services", c.GetServicesInfoByProjectId).Methods("GET")
	router.HandleFunc("/project/{projectId}/services/{serviceId}", c.GetServiceInfo).Methods("GET")
	router.HandleFunc("/project/{projectId}/services", c.CreateServiceInfo).Methods("POST")
	router.HandleFunc("/project/{projectId}/services/{serviceId}", c.UpdateServiceInfo).Methods("PATCH")
	router.HandleFunc("/project/{projectId}/services/{serviceId}", c.DeleteServiceInfo).Methods("DELETE")
	return router
}
...
func SetHeathRoutes(router *mux.Router) *mux.Router {
